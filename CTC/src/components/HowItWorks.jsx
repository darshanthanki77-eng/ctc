    ...
    <section className="section-padding section-white">
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto 52px auto' }}>
          <div className="glass-pill" style={{ marginBottom: '14px' }}>3-Step Execution</div>
          <h2 style={{ fontSize: 'clamp(1.9rem, 3.5vw, 2.9rem)', marginBottom: '14px' }}>
            How <span className="text-gradient">NEXUS AI Works</span>
          </h2>
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="glass-card" onClick={() => setActiveStep(idx)} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: '1.5rem', fontWeight: 800, fontFamily: 'var(--font-display)', color: activeStep === idx ? '#7C3AED' : '#D1D5DB' }}>{step.num}</span>
