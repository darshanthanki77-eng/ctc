    ...
    <section style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: '860px', margin: '0 auto' }}>
          ...
          {/* Badge */}
          <div className="glass-pill animate-float" style={{ marginBottom: '24px' }}>
            <span style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#7C3AED', display: 'inline-block' }} />
            AI-Powered Quantum Liquidity Protocol v4.2
          </div>
          ...
          <p style={{
            ...
            Sub-millisecond liquidity routing, decentralized multi-chain compute, and algorithmic yield optimization — built for institutions.
          </p>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={idx} className="glass-card" style={{ padding: '22px', textAlign: 'left' }}>
                ...
                <div style={{ fontSize: '1.9rem', fontWeight: 800, fontFamily: 'var(--font-display)', color: '#111827' }}>
                  {item.value}
                </div>
