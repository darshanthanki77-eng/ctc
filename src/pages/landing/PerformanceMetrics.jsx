...
const PerformanceMetrics = () => {
  ...
  return (
    <section id="performance" className="lp-section-padding lp-section-alt">
      <div className="lp-container">
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto 52px auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.9rem, 3.5vw, 2.9rem)', marginBottom: '14px' }}>
            Unmatched <span className="lp-text-gradient">Performance</span>
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
          {metrics.map((m, idx) => (
            <div key={idx} className="lp-glass-card" style={{ padding: '32px', textAlign: 'center' }}>
              <div style={{ fontSize: '2.6rem', fontWeight: 800, fontFamily: 'var(--lp-font-display)', color: '#111827', marginBottom: '4px' }}>
                {m.value}
              </div>
