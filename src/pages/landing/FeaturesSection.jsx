...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="lp-section-padding lp-section-white">
      <div className="lp-container">
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto 52px auto' }}>
          <div className="lp-glass-pill" style={{ marginBottom: '14px' }}>Platform Capabilities</div>
          <h2 style={{ fontSize: 'clamp(1.9rem, 3.5vw, 2.9rem)', marginBottom: '14px' }}>
            Built for <span className="lp-text-gradient">Unlimited Scale</span>
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
          {features.map((item, idx) => (
            <div key={idx} className="lp-glass-card" style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
