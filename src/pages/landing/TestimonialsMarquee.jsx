...
const TestimonialsMarquee = () => {
  const row1 = [
    { name: 'Alexander Vance', role: 'Managing Partner, Vance Capital', text: 'CTC transformed our algorithmic liquidity execution. Sub-millisecond latency and zero MEV slippage saved us millions.', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=80&q=80' },
    ...
    { name: 'Dr. Marcus Thorne', role: 'Chief AI Architect, Neural Labs', text: 'zk-SNARK encryption combined with autonomous routing makes CTC the premier institutional protocol.', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=80&q=80' },
  ];

  const row2 = [
    { name: 'Sarah Chen', role: 'Co-Founder, CyberVentures', text: 'Integrating CTC took our trading desk from zero to $800M volume in under 30 days. Phenomenal infrastructure.', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=80&q=80' },
  ...
  const TestimonialCard = ({ item }) => (
    <div className="lp-glass-card" style={{ width: '360px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '14px', flexShrink: 0 }}>
  ...
  return (
    <section className="lp-section-padding lp-section-white" style={{ overflow: 'hidden' }}>
      <div className="lp-container" style={{ marginBottom: '52px' }}>
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto' }}>
          <div className="lp-glass-pill" style={{ marginBottom: '14px' }}>Institutional Endorsements</div>
          <h2 style={{ fontSize: 'clamp(1.9rem, 3.5vw, 2.9rem)', marginBottom: '14px' }}>
            Trusted by <span className="lp-text-gradient">Industry Pioneers</span>
          </h2>
          <p style={{ color: '#6B7280', fontSize: '1.05rem' }}>Leading fund managers, researchers, and founders building on CTC.</p>
        </div>
      </div>
