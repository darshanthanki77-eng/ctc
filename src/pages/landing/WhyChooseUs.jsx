...
const WhyChooseUs = () => {
  ...
  return (
    <section id="why-us" className="lp-section-padding lp-section-alt">
      <div className="lp-container">
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto 52px auto' }}>
          <div className="lp-glass-pill" style={{ marginBottom: '14px' }}>
            <Award size={14} /> Why CTC?
          </div>
          <h2 style={{ fontSize: 'clamp(1.9rem, 3.5vw, 2.9rem)', marginBottom: '14px' }}>
            The Protocol of <span className="lp-text-gradient">Choice</span>
          </h2>
        ...
        {/* Benchmark */}
        <div className="lp-glass-card" style={{ padding: '36px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '32px', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ color: '#6B7280', lineHeight: 1.6, marginBottom: '20px' }}>
                Traditional DEX aggregators suffer high latency, front-running, and gas overhead. CTC eliminates all friction.
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              {[
                { label: 'CTC Protocol', value: '0.002ms', pct: '98%' },
                ...
                <div key={i}>
                  ...
                  <div style={{ width: '100%', height: '8px', borderRadius: '999px', background: '#F3F4F6', overflow: 'hidden' }}>
                    <div style={{ width: row.pct, height: '100%', background: row.muted ? '#D1D5DB' : 'var(--lp-brand-gradient)', borderRadius: '999px' }} />
                  </div>
                </div>
              ))}
            </div>
